...
The background image is chosen in dependance of the weather forecast. The website is styled in a way that it can be viewed on devices with different screen sizes. Vendor prefixes assure that the website can be seen correctly on different browsers.
